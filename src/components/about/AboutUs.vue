<template>
    <v-container>
        ...
        <v-row>
            <v-col>
                <v-img lazy-src="@/assets/imgs/about/about-1.jpg" src="@/assets/imgs/about/about-1.jpg" alt="cook-prepping-pizza-anna-shvets"></v-img>
            </v-col>
        </v-row>
        <v-row>
            <v-col>
        ...
        <v-row>
            <v-col>
                <v-img src="@/assets/imgs/about/about-2.jpg" alt="chef-prepping-pizza-kampus-productions"></v-img>
            </v-col>
        </v-row>
        <v-row>
            <v-col>
